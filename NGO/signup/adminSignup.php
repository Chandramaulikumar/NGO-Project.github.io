...
?>
    ...
    <img class="mb-4" src="../images/index/logo.png" alt="" width="72" height="72">
        ...
        <p>	PASSWORD:
            <input type="password" name="password" required placeholder="Enter Your Password" size="30" width="180px"/></p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	NAME:
            <input type="text" name="name" required placeholder="Enter Your Name"size="30" width="180px"/></p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; EMAIL:
            <input type="email" name="email" required placeholder="Enter Your Email"  width="180px" size="30"/></p>
        <p>&nbsp;&nbsp; MOB NO:
        <input type="text" name="phone" required placeholder="Enter Your Moblieno"  width="180px" size="30" pattern="[6789][0-9]{9}"/></p>
        <p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CITY : 
