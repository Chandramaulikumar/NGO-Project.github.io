...
?>
    ...
    <h1 class="h3 mb-3 font-weight-normal">Enter Your Details</h1>
        ...
        <p>	BANK NAME:
            <input type="text" name="bank" required placeholder="Enter Bank Name"  width="180px" size="40"/></p>
        <p>	&nbsp;&nbsp;&nbsp;IFSC CODE:
            <input type="text" name="ifsc_code" required placeholder="Enter IFSC Code"  width="180px" size="40"/></p>
        <p> &nbsp;&nbsp;&nbsp;&nbsp;ACCO NO:
            <input type="text" name="acount" required placeholder="Enter Account No"  width="180px" size="40"/></p>
        </p>
        <p>INITIAL DONATION:
            <input type="number" value=0 name="donation" style="width:290px;"/></p>
        </p>
